    ...
    <section ref={sectionRef} className="py-32 bg-white text-black">
      <div className="section-padding container-max">
        <div className="text-center max-w-4xl mx-auto">
          <h2 className={`text-5xl md:text-6xl font-black mb-8 transition-all duration-1000 ${
          ...
          <p className={`text-2xl text-gray-600 mb-12 transition-all duration-1000 delay-200 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
          ...
          >
            <input
              ...
              className="flex-1 px-6 py-4 border-2 border-black text-lg focus:outline-none focus:border-gray-600"
              required
            />
            <button
              type="submit"
