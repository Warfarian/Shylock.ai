...
const ExamplesSection: React.FC = () => {
  ...
  return (
    <section id="examples" ref={sectionRef} className="py-32 bg-gray-50 text-black">
      <div className="section-padding container-max">
        ...
        <div className="max-w-4xl mx-auto">
          <div className={`transition-all duration-500 ${
            ...
            <div className="bg-white p-12 border border-gray-200 shadow-lg">
              <div className="mb-8">
              ...
              <blockquote className="text-lg leading-relaxed font-serif text-gray-800 mb-8">
              ...
              <div className="flex items-center gap-4 p-4 bg-gray-100 rounded">
                ...
                <span className="text-sm text-gray-600 font-mono">2:34</span>
              </div>
            </div>
          </div>
        </div>
